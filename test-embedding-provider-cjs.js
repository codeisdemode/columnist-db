// Test Embedding Provider Integration (CommonJS)

console.log('🧪 Testing Embedding Provider Integration (CommonJS)...\n');

async function testEmbeddingProvider() {
  try {
    // Import the Memory Manager and BasicEmbeddingProvider using CommonJS
    const { MemoryManager, BasicEmbeddingProvider } = require('./packages/core/dist/memory/index.js');
